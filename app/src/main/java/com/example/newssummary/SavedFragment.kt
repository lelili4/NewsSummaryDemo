...
import com.example.newssummary.databinding.FragmentSavedBinding
...
//            this.putSerializable("selected_article", it)
//        }
            val bundle = Bundle()
        ...
        initRecyclerView()
        viewModel.getSavedNews().observe(this@SavedFragment) {
